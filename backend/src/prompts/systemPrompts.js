...
INJECTION RULES:
1. Разрешается склонять термины, менять падежи, числа и формы слова.
...
• target_audience — описание целевой аудитории (дословно или максимально близко к тексту)
...
• constraints — ограничения проекта (массив строк: нет экспертов / слабый бренд / мало ссылок / нет разработки / ограниченный бюджет / только блог / только коммерческие страницы / нет видео-команды / нет reviewers / мало авторов — только явно упомянутые)
• priority_page_types — приоритетные типы страниц (массив строк: блог / категории / услуги / продукты / сравнения / локальные страницы / glossary / knowledge base / tools — только явно упомянутые)
• niche_features — особенности ниши (массив строк: YMYL / highly regulated / seasonal / local-heavy / expert-led / trend-driven / marketplace-dominated / forum-dominated — только явно упомянутые)
...
• audience_segments — сегменты аудитории (массив строк, только если явно перечислены)
