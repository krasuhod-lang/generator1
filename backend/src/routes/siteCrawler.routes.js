...
const c         = require('../controllers/siteCrawler.controller');
...
router.get   ('/tasks/:id/pages',      readLimiter,  auth, c.listPages);
router.get   ('/tasks/:id/tree',       readLimiter,  auth, c.getTree);
