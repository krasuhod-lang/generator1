 ...
 *   • title       — SEO-заголовок, строго ≤ 60 символов;
 *   • description — meta description, строго ≤ 160 символов.
 *
...
const SYSTEM_PROMPT = [
  ...
  '',
  'Требования:',
  `• title — до ${TITLE_MAX} символов включительно, цепляющий, с главным`,
  '  ключевым словом ближе к началу.',
  `• description — до ${DESC_MAX} символов включительно, раскрывает суть`,
