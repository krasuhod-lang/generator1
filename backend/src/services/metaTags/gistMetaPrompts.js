...
- Кириллический safe range: 70–80 символов (включая пробелы); целься в 72–78,
  чтобы не выпасть за границу на ±1 символ.
...
- Кириллический safe range desktop: 180–190 символов; целься в 183–188, чтобы
  не выпасть за границу на ±1 символ. GIST-фактор description —
...
ОБЯЗАТЕЛЬНЫЕ LSI: если передан блок [ОБЯЗАТЕЛЬНЫЕ LSI ТОПа] — КАЖДОЕ слово
из него обязано войти в title или description (любая естественная словоформа:
«карт» → «карты/картой»). Эти слова есть у ≥50% конкурентов — без них CTR
ниже. Вплетай их органично в осмысленные фразы; ЗАПРЕЩЕНЫ перечисления голых
ключей через запятую и хвосты «Также: …».
