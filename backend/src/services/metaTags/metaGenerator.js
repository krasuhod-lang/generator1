 ...
 *
 * ВАЖНО про актуальность: SERP может быть закэширован и подсовывать прошлый
 * год (типичный пример: на дворе 2026, а в выдаче ещё «… 2025 …»). Если так —
 * принудительно используем текущий календарный год: пусть лучше Title будет
 * с актуальным годом, чем модель «вшьёт» устаревшую цифру и нам потом руками
 * править.
 */
