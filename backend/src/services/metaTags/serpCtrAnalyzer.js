...
// Синхронно с lengthHelpers.CTA_RE / snippetAnalyzer.CTA_DEFS: императив +
// инфинитивные CTA («Сравнить условия», «Подобрать программу»).
const CTA_PATTERNS = [
  ...
  /(?:^|[\s«"„])(узна(?:йте|й|ть)|подробн)/i,
  /(?:^|[\s«"„])(заходите|посет(?:и|ите))/i,
  /(?:^|[\s«"„])(оформ(?:и|ите)|оформить)/i,
  /(?:^|[\s«"„])(сравн(?:ите|и|ить)|подбер(?:ите|и)|подобрать)(?![а-яё])/i,
  /(?:^|[\s«"„])(заполн(?:ите|и|ить)|оцен(?:ите|и|ить)|провер(?:ьте|ь|ить))(?![а-яё])/i,
  /(?:^|[\s«"„])(чита(?:йте|й)|прочит(?:айте|ать)|изуч(?:ите|и|ить)|смотрите)(?![а-яё])/i,
];
