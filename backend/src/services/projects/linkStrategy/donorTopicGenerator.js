...
function _buildPrompt({ project, targets }) {
  ...
  return [
    ...
    '— title — кликабельный, интригующий заголовок (70–80 символов), который РАСКРЫВАЕТ',
    ...
    '— description — meta-description 180–190 символов: суть статьи + выгода для читателя,',
    ...
    '{"ready_topic": "готовая тема статьи (рабочий заголовок)", "h1": "H1 статьи", "title": "интригующий SEO-title, раскрывает интент, не похож на тему", "description": "meta-description 180–190 символов", "angle": "угол раскрытия одним предложением"}',
    '',
    'Анкоры/запросы:',
    list,
  ].join('\n');
