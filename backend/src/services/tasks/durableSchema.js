...
async function ensureDurableTaskSchema(db = dbDefault) {
  const statements = [
    ...
    `ALTER TABLE tasks ADD COLUMN IF NOT EXISTS writing_profile_json JSONB NOT NULL DEFAULT '{}'::jsonb`,
    ...
    `ALTER TABLE info_article_tasks ADD COLUMN IF NOT EXISTS writing_profile_json JSONB NOT NULL DEFAULT '{}'::jsonb`,
    `ALTER TABLE link_article_tasks ADD COLUMN IF NOT EXISTS writing_profile_json JSONB NOT NULL DEFAULT '{}'::jsonb`,
    ...
    `CREATE INDEX IF NOT EXISTS ix_tasks_writing_profile ON tasks USING GIN (writing_profile_json)`,
    `CREATE INDEX IF NOT EXISTS ix_info_article_tasks_writing_profile ON info_article_tasks USING GIN (writing_profile_json)`,
    `CREATE INDEX IF NOT EXISTS ix_link_article_tasks_writing_profile ON link_article_tasks USING GIN (writing_profile_json)`,
    ...
    `ALTER TABLE info_article_tasks ADD COLUMN IF NOT EXISTS qwen_tokens_in BIGINT NOT NULL DEFAULT 0`,
    `ALTER TABLE info_article_tasks ADD COLUMN IF NOT EXISTS qwen_tokens_out BIGINT NOT NULL DEFAULT 0`,
    `ALTER TABLE info_article_tasks ADD COLUMN IF NOT EXISTS qwen_cost_usd NUMERIC(18,12) NOT NULL DEFAULT 0`,
    ...
    `ALTER TABLE link_article_tasks ADD COLUMN IF NOT EXISTS qwen_tokens_in BIGINT NOT NULL DEFAULT 0`,
    `ALTER TABLE link_article_tasks ADD COLUMN IF NOT EXISTS qwen_tokens_out BIGINT NOT NULL DEFAULT 0`,
    `ALTER TABLE link_article_tasks ADD COLUMN IF NOT EXISTS qwen_cost_usd NUMERIC(18,12) NOT NULL DEFAULT 0`,
    ...
    `ALTER TABLE task_metrics ADD COLUMN IF NOT EXISTS qwen_tokens_in BIGINT NOT NULL DEFAULT 0`,
    `ALTER TABLE task_metrics ADD COLUMN IF NOT EXISTS qwen_tokens_out BIGINT NOT NULL DEFAULT 0`,
    `ALTER TABLE task_metrics ADD COLUMN IF NOT EXISTS qwen_cost_usd NUMERIC(18,12) NOT NULL DEFAULT 0`,
    ...
    `ALTER TABLE task_metrics ALTER COLUMN qwen_cost_usd TYPE NUMERIC(18,12)`,
