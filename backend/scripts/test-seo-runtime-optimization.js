...
const checks = [
  ...
  ['stage 4 and stage 7 use overridable fast audit model', /SEO_AUDIT_MODEL \|\| 'deepseek-v4-flash'/.test(stage4) && /SEO_AUDIT_MODEL \|\| 'deepseek-v4-flash'/.test(stage7)],
  ['stage 4 re-audit uses compact output mode', /RE-AUDIT COMPACT MODE/.test(stage4) && /maxTokens: 8000/.test(stage4)],
  ['stage 5 repair calls use bounded output and retries', /maxTokens: 12288/.test(stage5) && /maxTruncationTokens: 16384/.test(stage5) && /retries: 2/.test(stage5)],
  ['stage 6 LSI calls use bounded output and retries', /maxTokens: 12288/.test(stage6) && /maxTruncationTokens: 16384/.test(stage6) && /retries: 2/.test(stage6)],
