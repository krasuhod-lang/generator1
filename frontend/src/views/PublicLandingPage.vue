...
onMounted(() => {
  // Предзагружаем auth views на landing: первый touch не должен ждать lazy chunk.
  void Promise.allSettled([import('./LoginPage.vue'), import('./RegisterPage.vue')]);
...
.desktop-nav { display: flex; align-items: center; gap: 31px; margin-left: auto; margin-right: 28px; }.desktop-nav a,.nav-login { color: #a9adbd; font-size: 12px; letter-spacing: .02em; text-decoration: none; -webkit-tap-highlight-color: rgba(131,116,255,.22); touch-action: manipulation; transition: color .18s ease; }.desktop-nav a:hover,.nav-login:hover { color: #fff; }
.nav-actions { display: flex; align-items: center; gap: 21px; }.button { display: inline-flex; align-items: center; justify-content: center; gap: 13px; min-height: 53px; -webkit-tap-highlight-color: rgba(131,116,255,.22); touch-action: manipulation; padding: 0 22px; border-radius: 5px; border: 1px solid transparent; font-size: 12px; font-weight: 700; letter-spacing: .01em; text-decoration: none; transition: transform .18s ease, background .18s ease, border-color .18s ease; }.button:hover { transform: translateY(-2px); }.button:active { transform: scale(.98); }.button span { font-size: 16px; line-height: 1; }.button-small { min-height: 39px; padding: 0 16px; font-size: 11px; }.button-primary { background: var(--violet); color: #fff; box-shadow: 0 9px 28px rgba(131,116,255,.25); }.button-primary:hover { background: #9589ff; }.button-ghost { color: #e6e4ec; border-color: rgba(255,255,255,.18); background: rgba(255,255,255,.04); }.button-ghost:hover { background: rgba(255,255,255,.1); }.button-light { background: var(--paper); color: var(--ink); }.button-light:hover { background: #fff; }
